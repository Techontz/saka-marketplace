...
import { Button, Field, FormError, Input } from "@/components/admin/ui";
  ...
  if (sent) {
    return (
      <AuthShell
        ...
        footer={
          <Link href="/admin/login" className="inline-flex min-h-11 items-center font-medium text-brand hover:underline">
            Back to sign in
          </Link>
        }
      >
