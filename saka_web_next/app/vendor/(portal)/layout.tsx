...
import type { Envelope, VendorDashboard } from "@/lib/vendor/api/types";
...
export default function PortalLayout({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    if (!isLoading && !isAuthenticated) router.replace("/vendor/login");
...
<span className="flex items-center gap-2">
      ...
      <div className="flex min-w-0 flex-col">
        ...
        */}
        {user && !user.can_publish_listings && !pathname.startsWith("/vendor/verification") && (
